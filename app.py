...
FOUNDATIONS = [
    ...
    {"code": "CV", "title": "Computer Vision: CNNs to the Frontier", "slug": "computer-vision",
     "tag": "Deep Learning", "accent": "#14b8a6", "level": "Beginner → Advanced", "hours": "26", "order": 15,
     "foundation": True, "certificate": False,
     "prereqs": ["deep-learning-foundations", "pytorch-essentials"],
     "blurb": "How machines see, end to end: pixels, convolutions, and vision transformers, then the "
              "modern frontier — adversarial examples, video, self-supervised learning, VAEs and GANs, "
              "diffusion models, 3D vision, CLIP and vision-language, and training at scale.",
     "outcomes": ["Explain why CNNs beat MLPs on images and read any conv stack's shapes and receptive fields",
                  "Build, train, and evaluate a CNN in PyTorch, then transfer-learn from a pretrained backbone",
                  "Understand detection, segmentation, ViTs, video models, and self-supervised backbones like DINOv2",
                  "Explain how VAEs, GANs, and diffusion models generate images — and how to evaluate them",
                  "Reason about 3D vision (NeRF, Gaussian splatting), CLIP, and scale — and bridge into the VLM course"],
     "syllabus": _syl(
        ...
        ("Visualizing and attacking CNNs", "Saliency, feature visualization, adversarial examples (FGSM), DeepDream, and style transfer."),
        ("Video understanding", "3D CNNs and I3D inflation, two-stream networks, SlowFast, video transformers, and the compute reality."),
        ("Self-supervised learning", "Contrastive learning (SimCLR, MoCo), DINO, masked autoencoders, and DINOv2 as the default backbone."),
        ("Generative models: VAEs and GANs", "The ELBO, reparameterization, the GAN minimax game, mode collapse, and FID."),
        ("Diffusion models", "Learning to denoise, latent diffusion, classifier-free guidance, and why diffusion beat GANs."),
        ("3D vision", "Voxels to point clouds to implicit fields; NeRF, 3D Gaussian splatting, and monocular depth."),
        ("Vision and language", "CLIP contrastive pretraining, zero-shot classification, open-vocabulary detection, and the VLM bridge."),
        ("Scale and the frontier", "Distributed training for vision, world models, human-centered vision, and the road from here."))},
